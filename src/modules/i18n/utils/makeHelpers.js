import { MALE_GENDER, FEMALE_GENDER, NO_GENDER } from '../../characters';
 ...
 * @returns {Function}
 */
const heSheIt = lang => ({ param = 'gender', transform = str => str } = {}) =>
    `{${param}, select,
 ...
 * @returns {Function}
 */
const hisHerIts = lang => ({ param = 'gender', transform = str => str } = {}) =>
    `{${param}, select,
 ...
 * @returns {Function}
 */
const himHerIt = lang => ({ param = 'gender', transform = str => str } = {}) =>
    `{${param}, select,
